        ...
        val stdout =
            captureStdout {
                ReportOutputs.emit(
                    ...
                    summaryLines =
                        listOf(
                            "Total Artifact transforms: ${sampleTransforms.size}",
                            "Build Scans with Artifact transforms: ${sampleTransforms.groupBy { it.buildScanId }.count()}",
                        ),
                )
            }
        ...
        val stdout =
            captureStdout {
                ReportOutputs.emit(
                    ...
                    summaryLines =
                        listOf(
                            "Build build1 - Total Artifact transforms: ${sampleTransforms.size} ",
                        ),
                )
            }
